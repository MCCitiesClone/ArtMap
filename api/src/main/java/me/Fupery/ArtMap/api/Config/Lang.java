...
public enum Lang implements LangSet<String> {
    ...
    ADMIN_RECIPE, RECIPE_HELP, RECIPE_EASEL_NAME, RECIPE_CANVAS_NAME, RECIPE_CANVAS_MEDIUM_NAME, RECIPE_CANVAS_LARGE_NAME, RECIPE_PAINT_BRUSH_NAME, RECIPE_ARTWORK_ARTIST, BUTTON_RENAME_NAME, BUTTON_DELETE_NAME,
    ...
    public enum Array implements LangSet<String[]> {
        ...
        INFO_TOOLS, TOOL_DYE, TOOL_PAINTBUCKET, TOOL_COAL, TOOL_FEATHER, TOOL_COMPASS, RECIPE_EASEL, RECIPE_CANVAS, RECIPE_CANVAS_MEDIUM, RECIPE_CANVAS_LARGE,
